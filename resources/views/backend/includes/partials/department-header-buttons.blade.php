<!--Action Button-->
<!--    @if(Active::checkUriPattern('admin/department'))
        <div class="btn-group">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="{{route('admin.department.index')}}"><i class="fa fa-list-ul"></i> {{trans('menus.backend.department.all')}}</a></li>
    @permission('create-department')
    <li><a href="{{route('admin.department.create')}}"><i class="fa fa-plus"></i> {{trans('menus.backend.department.create')}}</a></li>
    @endauth
  </ul>
</div>
